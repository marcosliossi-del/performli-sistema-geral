...
const TEMPLATES_ECOM: SeedTemplate[] = [
  {
    ...
    description: SOP_ECOM_01, steps: STEPS_ECOM_01, tags: ['CS'], enforceChecklist: true,
  ...
  },
  {
    ...
    description: SOP_ECOM_02, steps: STEPS_ECOM_02, tags: ['CS'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_03, steps: STEPS_ECOM_03, tags: ['review', 'tráfego'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_04, steps: STEPS_ECOM_04, tags: ['otimização', 'tráfego'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_05, steps: STEPS_ECOM_05, tags: ['tráfego'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_06, steps: STEPS_ECOM_06, tags: ['review', 'tráfego'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_07, steps: STEPS_ECOM_07, tags: ['review', 'tráfego'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_08, steps: STEPS_ECOM_08, tags: ['CS'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_09, steps: STEPS_ECOM_09, tags: ['CS', 'review'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_10, tags: ['review'], enforceChecklist: false,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_11, steps: STEPS_ECOM_11, tags: ['review', 'tráfego'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_12, tags: ['tráfego'], enforceChecklist: false,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_13, steps: STEPS_ECOM_13, tags: ['CS'], enforceChecklist: true,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_14, tags: ['review'], enforceChecklist: false,
    businessType: 'ECOMMERCE', activeRule: false,
  ...
  },
  {
    ...
    description: SOP_ECOM_15, tags: ['crm', 'review'], enforceChecklist: false,
    businessType: 'ECOMMERCE', activeRule: false,
    recurrence: { frequency: 'DIA_DO_MES', dayOfMonth: 1, rollToBusinessDay: true, hour: 12 },
  },
  {
    code: 'REC-ECOM-RELATORIO-SEMANAL-CRM', name: 'Relatório Semanal [CRM]', role: 'CRM', area: 'CRM_AUTOMACAO', priority: 'CRITICA',
    description: SOP_ECOM_16, tags: ['crm', 'review'], enforceChecklist: false,
    businessType: 'ECOMMERCE', activeRule: false,
    recurrence: { frequency: 'SEMANAL', dayOfWeek: 1, hour: 12 },
  },
]
