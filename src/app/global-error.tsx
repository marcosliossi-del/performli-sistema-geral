...
/**
 * Error boundary raiz — só dispara quando o próprio layout raiz falha (a
 * sidebar/topbar não montam). Precisa renderizar <html>/<body> próprios.
 * Mesma linguagem operacional do (dashboard)/error.tsx.
 */
export default function GlobalError({
  ...
  return (
    <html lang="pt-BR">
      <body style={{ background: '#05141C', margin: 0 }}>
        <div className="min-h-screen bg-[#05141C] flex flex-col items-center justify-center p-8 text-center">
          ...
          <h1 className="text-lg font-semibold text-[#EBEBEB]">O sistema não carregou</h1>
          <p className="text-sm text-[#87919E] mt-1 max-w-md">
            Algo falhou ao montar o Performli. Tente de novo; se persistir, avise
            o time técnico.
          </p>
          {error.digest && (
